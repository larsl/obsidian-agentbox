...
echo ""
echo "    Claude Code benötigt einen API-Schlüssel von Anthropic."
echo "    Du hast zwei Möglichkeiten:"
echo ""
echo "    Option 1: Globale Umgebungsvariable (empfohlen)"
echo "    Füge diese Zeile zu deiner ~/.zshrc hinzu:"
echo ""
echo "        export ANTHROPIC_API_KEY=\"dein-api-schlüssel\""
echo ""
echo "    Option 2: .env-Datei für agentbox"
echo "    Erstelle die Datei ~/.agentbox/.env mit dem Inhalt:"
echo ""
echo "        ANTHROPIC_API_KEY=dein-api-schlüssel"
echo ""
echo "    Einen API-Schlüssel bekommst du unter: https://console.anthropic.com/"
echo ""
